...
DROP TABLE IF EXISTS #cas
	...
	FROM (
		SELECT o.UserID, 
            ...
            -- SUM(CASE WHEN o.CalculationDate < '2021-03-01' THEN 
            --         CASE WHEN cg.GameProviderID IN (48, 10)
			-- 		    AND o.TypeId = 1
			-- 		    AND o.OrderDate > '2020-05-20 06:45:00' THEN o.OrderAmount * o.Odds / 100 
            --         ELSE (o.OrderAmount - o.WinAmount) END 
            --     ELSE CASE WHEN cg.GameProviderID IN (48, 10)
			-- 		AND o.TypeId = 1
			-- 		AND o.OrderDate > '2020-05-20 06:45:00' THEN o.OrderAmount * o.Odds / 100 WHEN cg.GameProviderID IN (48, 10)
			-- 		AND o.TypeId IN (5, 8, 18, 33) THEN (o.OrderAmount - o.WinAmount) WHEN cg.GameProviderID NOT IN (48, 10) THEN (o.OrderAmount - o.WinAmount) 
            --     ELSE 0 
            --     END END) GGR
		...
		WHERE o.CalculationDate >= '2022-10-01' AND o.CalculationDate < GETDATE()
